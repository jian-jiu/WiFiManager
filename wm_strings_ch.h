...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>已保存信息<br/>设备正在尝试连接到WiFi网络<br />如果连接失败，请重新连接热点<br/>或者浏览器访问 <a href='http://192.168.4.1/' target='_blank'>http://192.168.4.1</a><br/>进行重新配置</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<td>显示WiFi扫描结果，并进行WiFi配置.(/0wifi noscan)</td></tr>"
 ...
 "<td>重启设备</td></tr>"
 "<tr><td>/erase</td>"
 "<td>清除WiFi配置并重新启动设备。在输入新的WiFi配置数据之前，设备将不会重新连接到网络</td></tr>"
 "</table>"
...
// @todo remove html elements from progmem, repetetive strings
    ...
    const char HTTP_INFO_hall[]       PROGMEM = "<dt>尔传感器</dt><dd>{1}</dd>";
#else
...
const char HTTP_INFO_apssid[]     PROGMEM = "<dt>热点名称</dt><dd>{1}</dd>";
const char HTTP_INFO_apbssid[]    PROGMEM = "<dt>BSSID</dt><dd>{1}</dd>";
const char HTTP_INFO_stassid[]    PROGMEM = "<dt>WiFi名称</dt><dd>{1}</dd>";
...
const char HTTP_INFO_stamac[]     PROGMEM = "<dt>AC地址</dt><dd>{1}</dd>";
